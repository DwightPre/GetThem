...
-- zombie
	...
	ply:ChatPrint ( "Not Enough $!")
		 ...
		 -- Guard
		 	...
		 	if ply:GetXp() > 200 then
				local i = 0
		 	local Guard1 = ents.Create("simple_guard")
...
PistolAmmoButton:SetText("Pistol Ammo")
...
PistolAmmoButton2:SetText("SMG Ammo")
...
PistolAmmoButton3:SetText("Crossbow Ammo")
...
PistolAmmoButton4:SetText("Shotgun Ammo")
...
PistolAmmoButton5:SetText("AR2 Ammo")
...
PistolAmmoButton6:SetText("Alyxgun ammo")
...
--
--       if(args[1] == gtObject[key]) then
--         local entity = gtObject[key]
--         if(ply:GetXp() > entity["Price"]) then
--           ply:Give(entity["cmdName"])
--           ply:ChatPrint("You got a " .. entity .. "!")
--           ply:SetXp( current_xp - 800 )
--       end
--     else
--       ply:ChatPrint("Not Enough cash to purchase " .. entity ..)
--       end
--     end
--
--   end
...
-- for key,value in pairs(gtObject) do
--   entity = gtObject[key]
-- local PistolButton = vgui.Create("DButton", entity["Shop tab"])
-- PistolButton:SetSize(entity["Shop size"])
-- PistolButton:SetPos(entity["Shop pos"])
-- PistolButton:SetText(entity)
-- PistolButton.DoClick = function() RunConsoleCommand("weapon_take", entity) WeaponFrame:Close() end
--
-- PistolButton.OnCursorEntered = function()
--   local icon = vgui.Create( "DModelPanel", PrevPanel )
--     icon:SetModel( entity["Model"] )
--     icon:SetSize( 1000, 1000 )
--     icon:SetCamPos(Vector (0, 100, 50))
--     icon:SetLookAt( Vector( 0, 0, 0 ) )
--     icon:Center()
--     CostText:SetText( "Cost: " .. tostring(entity["Price"]) ..)
--     function icon:LayoutEntity( Entity ) return end
--   end
--   PistolButton.OnCursorExited = function()
--     CostText:SetText( "Cost: ")
